...
public class VacuumWorldCleanerMind extends VacuumWorldDefaultMind{
...
private int count = 0;
	...
	public VacuumWorldCleanerMind(String bodyId) {
		super(bodyId);
	}
	...
	/**
	 * Finds the closest peice of dirt and builds a plan to get to it, this uses manhatten distance.
	 * @param perception
	 * @param closestDirt
	 */
	...
	/**
	 * This will update the agents internal memory to store the location of any peices of dirt.
	 * @param perception
	 */
